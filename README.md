...
$ cmake -DBENCHMARK_DOWNLOAD_DEPENDENCIES=on -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wno-invalid-offsetof -Wno-reduced-alignment -Wno-error=unused-function" -S . -B "build"
# Build the library.
